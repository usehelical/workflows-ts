...
export type WorkflowSignature<TArgs extends unknown[] = unknown[], TReturn = unknown> = {
  name: string;
  __args?: TArgs; // Phantom type - never exists at runtime, only for type inference
  __return?: TReturn; // Phantom type
};
